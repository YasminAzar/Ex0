...
public class testPolynom {
	...
	public static void main(String[] args) {
		...
		System.out.println("copy constructor: " + p); 
		/**
...
//		 */
		...
		p8.derivative();
		System.out.println("\nderivative : \nf(2x^3 + 4x^2 + 5x^1 + 9)'= " + p8.derivative());
		/**
		...
		Polynom p13 = new Polynom("4x^4+8x^1-88");
		Polynom p14 = new Polynom("4x^4");
		System.out.println("\nequals :\n4x^4+8x^1+88 == 4x^4+8x^1+88+0 ? " + p11.equals(p12));
		System.out.println("4x^4+8x^1+88 == 4x^4+8x^1+88 ? " + p12.equals(p12));
		System.out.println("4x^4+8x^1+88 == 4x^4+8x^1-88 ? " + p11.equals(p13));
		System.out.println("4x^4+8x^1+88 == 4x^4 ? " + p11.equals(p14));

		/**
		 * testing if the Polynom is zero
		 */
		System.out.println("\nCheacking for zero function:");
		Polynom p15 = new Polynom("0+0x^0+0.0+0x^2+0*x");
		Polynom p16 = new Polynom("0+0x^0+0.0+0x^2+2*x");
		System.out.println("f(x)= 0+0x^0+0.0+0x^2+0x is zero function? " + p15.isZero());
		System.out.println("f(x)= 0+0x^0+0.0+0x^2+2x is zero function? " + p16.isZero());
	}
}
