...
public class testMonom {
	...
	public static void main(String[] args) {
		...
		/**
		 * test to check if the monom is Zero.
		 */
		
		System.out.println("\n did 0 is equals zero ? : " +a8.isZero());
		System.out.println("\n did -6 is equals zero ? : " +a9.isZero());
		System.out.println("\n did 6x^0 is equals zero ? : " +a11.isZero());
